...
import { UsuariosWrapper } from '@/components/usuarios/usuarios-wrapper-simple';
          ...
          <CardContent>
            ...
            >
              <UsuariosWrapper 
                ...
                podeCriar={session.user.userType === 'ADMIN'}
                podeEditar={session.user.userType === 'ADMIN' || session.user.userType === 'SUPERVISOR'}
                podeDesativar={session.user.userType === 'ADMIN'}
              />
            </Suspense>
          </CardContent>
        </Card>
